...
if __name__ == '__main__':
    ...
    parser.add_argument('--image', type=str, default=r'mmexport1690774465381.jpg', help='detect images')
    parser.add_argument('--fourcc', type=int, default=0, help='detect on webcam')
    ...
    if args.fourcc ==0:
        ...
        while True:
            ...
            fps = 1 / timeDelta
            cv2.putText(frame, "FPS: " + str(int(fps)), (10, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
